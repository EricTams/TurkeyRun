...
export const POOL_TUBE_SQUISH_DURATION = 0.12;
...
export const GRACKLE_TURN_RATE = 1.0;       // radians/s for shorter grackle aim window
...
export const BOAR_PATTERN_CHANCE = 0.5;     // hard/extreme patterns: chance to choose boar set
