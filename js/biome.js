...
const BIOMES = [
    {
        ...
        ground: '#C2B280',
        groundStripe: '#B0A06A',
        groundHazards: ['oldIguana', 'poolTube'],
    ...
    },
    {
        ...
        ground: '#8B7D6B',
        groundStripe: '#736B5C',
        groundHazards: ['boulder', 'icePatch', 'iceIguana', 'poolTube'],
    ...
    },
    {
        ...
        ground: '#9A9A9A',
        groundStripe: '#7A7A7A',
        groundHazards: ['crater', 'alienRock', 'iceIguana', 'poolTube'],
        skyBlockers: ['mediumAsteroid', 'largeAsteroid', 'ufo'],
    ...
    },
    {
        ...
        ground: '#3A0060',
        groundStripe: '#5A0085',
        groundHazards: ['tieDyeIguana', 'poolTube'],
        skyBlockers: ['largeAsteroid', 'ufo', 'thoughtBubble'],
