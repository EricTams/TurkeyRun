...
export const GADGETS = {
    ...
    ezyDodge:     { name: 'Ezy-Dodge',    category: 'survival', levels: [
    ...
    coinMagnet:   { name: 'Coin Magnet',  category: 'economy', levels: [
        { desc: '2x food pickup radius',                   cost: 300  },
        { desc: '3x food pickup radius',                   cost: 600  },
        { desc: '4x radius + food drifts to you',         cost: 900  },
    ]},
    coinDoubler:  { name: 'Coin Doubler', category: 'economy', levels: [
        { desc: '1.5x coins earned',                       cost: 500  },
        { desc: '2x coins earned',                         cost: 1000 },
        { desc: '2.5x coins earned',                       cost: 1500 },
    ]},
    ...
    streakMaster: { name: 'Streak',       category: 'economy', levels: [
        { desc: '10 food streak: +50% coins 5s',          cost: 400  },
        { desc: '7 food streak: +50% coins 5s',           cost: 800  },
        { desc: '5 food streak: +100% coins 5s',          cost: 1200 },
    ]},
    ...
    compoundInterest: { name: 'Compound', category: 'economy', levels: [
    ...
    moneyGrubber: { name: 'Grubber',      category: 'economy', levels: [
        { desc: 'Earn 1 coin every 3s passively',         cost: 400  },
        { desc: 'Earn 1 coin every 2s passively',         cost: 800  },
        { desc: 'Earn 1 coin every 1.5s + coin trail',    cost: 1200 },
    ]},
};
...
export const PASSIVES = {
    ...
    partingGift:  { name: 'Parting Gift',   category: 'economy',  tiers: [
        { desc: '+2% distance as bonus coins',  cost: 100 },
        { desc: '+4% distance as bonus coins',  cost: 180 },
        { desc: '+6% distance as bonus coins',  cost: 325 },
        { desc: '+8% distance as bonus coins',  cost: 585 },
        { desc: '+10% distance as bonus coins', cost: 1050 },
    ]},
...
export const TREE_NODES = [
    ...
    // Main trunk up: Shield line
    gadgetNode('shield_1',    'shield', 0, 0, -1),
    gadgetNode('shield_2',    'shield', 1, 0, -2),
    gadgetNode('ezyDodge_1',  'ezyDodge', 0, 0, -3),
    gadgetNode('ezyDodge_2',  'ezyDodge', 1, 0, -4),
    gadgetNode('ezyDodge_3',  'ezyDodge', 2, 0, -5),

    // Branch left from shield_2: Flash
    gadgetNode('flash_1',     'flash', 0, -1, -2),
    gadgetNode('flash_2',     'flash', 1, -2, -2),
    gadgetNode('flash_3',     'flash', 2, -3, -2),

    // Branch right from shield_1: Tough Feathers passive + Adrenaline
    ...
    // Branch left from ezyDodge_1: Decoy
    gadgetNode('decoy_1',     'decoy', 0, -1, -3),
    gadgetNode('decoy_2',     'decoy', 1, -2, -3),
    gadgetNode('decoy_3',     'decoy', 2, -3, -3),

    // Branch right from ezyDodge_1: Second Chance passive
    ...
    // Branch up from ezyDodge_3: Shield Lv3 + Hazard Jammer
    ...
    // Branch right from shield_3: Thick Skin + Second Wind
    ...
    // Main trunk down: Coin Magnet line
    gadgetNode('coinMag_1',    'coinMagnet', 0, 0, 1),
    gadgetNode('coinMag_2',    'coinMagnet', 1, 0, 2),
    gadgetNode('coinDoub_1',   'coinDoubler', 0, 0, 3),
    gadgetNode('coinDoub_2',   'coinDoubler', 1, 0, 4),
    gadgetNode('coinDoub_3',   'coinDoubler', 2, 0, 5),

    // Branch right from coinMag_1: Nest Egg passive
    ...
    // Branch left from coinMag_2: Bounty Hunter
    gadgetNode('bounty_1',     'bountyHunter', 0, -1, 2),
    gadgetNode('bounty_2',     'bountyHunter', 1, -2, 2),
    gadgetNode('bounty_3',     'bountyHunter', 2, -3, 2),

    // Branch right from coinMag_2: Parting Gift passive
    passiveNode('partGift_1',  'partingGift', 0, 1, 2),
    passiveNode('partGift_2',  'partingGift', 1, 2, 2),
    passiveNode('partGift_3',  'partingGift', 2, 3, 2),
    passiveNode('partGift_4',  'partingGift', 3, 4, 2),
    passiveNode('partGift_5',  'partingGift', 4, 5, 2),

    // Branch left from coinDoub_1: Streak Master
    gadgetNode('streak_1',     'streakMaster', 0, -1, 3),
    gadgetNode('streak_2',     'streakMaster', 1, -2, 3),
    gadgetNode('streak_3',     'streakMaster', 2, -3, 3),

    // Branch right from coinDoub_1: Bargain Hunter passive
    passiveNode('bargain_1',   'bargainHunter', 0, 1, 3),
    passiveNode('bargain_2',   'bargainHunter', 1, 2, 3),
    passiveNode('bargain_3',   'bargainHunter', 2, 3, 3),

    // Branch right from coinDoub_3: 3rd/4th slot milestones
    milestoneNode('thirdSlot',  'thirdSlot',  1, 5),
    milestoneNode('fourthSlot', 'fourthSlot', 2, 5),

    // Branch down from coinDoub_3: Money Grubber + deeper economy
    gadgetNode('grubber_1',    'moneyGrubber', 0, 0, 6),
    gadgetNode('grubber_2',    'moneyGrubber', 1, 0, 7),
    gadgetNode('grubber_3',    'moneyGrubber', 2, 0, 8),

    // Branch left from grubber_1: Gemologist
    gadgetNode('gem_1',        'gemologist', 0, -1, 6),
    gadgetNode('gem_2',        'gemologist', 1, -2, 6),
    gadgetNode('gem_3',        'gemologist', 2, -3, 6),

    // Branch right from grubber_1: Compound Interest
    gadgetNode('compound_1',   'compoundInterest', 0, 1, 6),
    gadgetNode('compound_2',   'compoundInterest', 1, 2, 6),
    gadgetNode('compound_3',   'compoundInterest', 2, 3, 6),

    // Branch left from grubber_3: Jackpot
    gadgetNode('jackpot_1',    'jackpot', 0, -1, 8),
    gadgetNode('jackpot_2',    'jackpot', 1, -2, 8),
    gadgetNode('jackpot_3',    'jackpot', 2, -3, 8),

    // Branch right from grubber_3: Token Gift
    gadgetNode('token_1',      'tokenGift', 0, 1, 8),
    gadgetNode('token_2',      'tokenGift', 1, 2, 8),
    gadgetNode('token_3',      'tokenGift', 2, 3, 8),

    // Milestones: deeper branches
    milestoneNode('gadgetSynergy', 'gadgetSynergy', -4, -3), // tip of streak branch
    milestoneNode('autoMagnet',    'autoMagnet',     6, 1),   // tip of nest egg branch
    milestoneNode('goldenRuns',    'goldenRuns',     5, 2),   // after parting gift
    milestoneNode('luckyStart',    'luckyStart',    -4, 8),   // after jackpot
];
